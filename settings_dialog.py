from PyQt5.QtWidgets import (
    ...
    QSpinBox, QCheckBox, QComboBox, QGroupBox, QSlider, QFrame, QSizePolicy
)
...
_GROUP_STYLE = (
    ...
    "border:1px solid #ddd;border-radius:6px;margin-top:8px;padding:8px 6px 6px 6px;}"
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet(
            ...
            "QSpinBox,QComboBox{border:1px solid #ccc;border-radius:4px;"
